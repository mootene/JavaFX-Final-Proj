...
public class About {
    ...
    public About(VBox vb) {
        ...
        body3Title = new Text("Public Lectures and Exhibitions");
                body3Title.setWrappingWidth(300);
        ...
        hb5.getChildren().addAll(body3Title);
        
        hb6.getChildren().addAll(body3);
        
        vbContent.getChildren().addAll(hb0, hb1, hb2, hb3, hb4, hb5, hb6, linkPane);
