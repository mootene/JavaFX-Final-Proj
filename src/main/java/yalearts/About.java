...
public class About {
    ...
    public About(VBox vb) {
        ...
        pageTitle = new Text("About The School");
                pageTitle.setWrappingWidth(100);
        ...
        body1Title = new Text(
                "The Yale School of Art is a graduate school that confers Master of Fine Arts Degrees in Graphic Design, Painting/Printmaking, Photography, and Sculpture");
                        body1Title.setWrappingWidth(100);
        ...
        body1 = new Text(
                ...
                body1.setWrappingWidth(300);

        body2Title = new Text("Master of Fine Arts Degree (MFAs)");
                body2Title.setWrappingWidth(100);
                ...
                body2.setWrappingWidth(300);

        body3Title = new Text("Public Lectures and Exhibitions");
                body3Title.setWrappingWidth(100);
